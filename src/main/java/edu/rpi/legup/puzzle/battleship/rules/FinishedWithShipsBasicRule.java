...
public class FinishWithShipsBasicRule extends BasicRule {
    ...
    //check if a cell is forced to be water or ship
    private boolean isForced(BattleshipBoard board, BattleshipCell cell) {
        ...
        // count the number of ship segments and unknowns in the column and compare them to make sure they are equal
    ...
    public Board getDefaultBoard(TreeNode node) {
        //creation of new transition board
